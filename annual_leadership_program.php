	...
	<div class="container1" style=" width:100%; border-bottom:#FF0000">
		<div class="row">
			<div class="col-12 text-center1" ><br /><Br /><br /><br><br>
				<img src="images/slider/will_leader_group_4_23.jpeg" alt="16 women leadership" style="width:100%">
			</div>
		</div>
	</div>
</section>
...
<h4>
16th WILL Annual Women in Leadership Program <br>"The Next Frontier for Women!" <br><br>
Program Dates: April 24-26, 2023<br><br>	
</h4>
<h5 style="color:#7608A9">
Three days Cross-industry Leadership Program for Women Executives and Professionals — that has produced over #1000 #WILLMentees
				...
				<div class="description-one">						
					...
					<div class="col-lg-8 col-sm-4 boxeffctcat1" style="background-color: white; text-align:left; float:left;" >
						<table border="1" cellpadding="8" width="100%">
							<tr>
								<td>
                                <strong style="color:#7608A9"> Leadership Focused Session Areas </strong><br />
									* Understanding the Power of Self !<br />
									* Executive Presence — the Gender Context of Leadership<br /> 
									* Communication in the Digital Era – Empowering the Tech Advantage<br /> 
									* Women on Boards & ESG – Sustainability and Compassionate Leadership <br />

                                   <br> <strong style="color:#7608A9"> Featuring Special Session on </strong><br />
									* Leadership Learning with Nature! - at Lodi Gardens Conservation Park <br />
									* Yoga and Meditation Session for Wellness<br /> 
									
                                    <br> <strong style="color:#7608A9"> Registration Fee: </strong> <br>
                                           * Rs. 25,000 for 3 days program :
                                            <br><b>* Group Discounts Available</b><br>

                                            <br><strong style="color:#7608A9"> Registration Fee Includes: </strong><br>

                                    * Networking  Tea and Lunch for 3 days<br>
                                    * Sit-down dinner for 2 nights - April 25 and 25<br>
                                    * Glittering Participants Certification Ceremony <br>
                                    * Walk in Lodi Gardens Conservation Park - Special Session on Leadership Learning with Nature!<br>
                                    * Copy of Book "Leadership by Proxy"<br>
                                    * Program reading materials<br>

                                    <br><b>* </b>Fee Does not include residential accommodation<br>
                                    This option can be requested separately with Accomodation charges
								</td>
							</tr>
						</table>
					</div>
					...
					<div style="text-align:center;" >
						...
						<div style="margin-top:2%;float:left;" class='col-md-8'> 
							<div class="col-lg-12 col-md-12 align-self-center" style="background-color:#008000; padding: 30px;">	
										...
										<form id='form' name='form' onsubmit="return validate();" action="#" class="row" method="post" enctype="multipart/form-data"  >
											<input type="hidden" name="tid" id="tid" readonly />
											<input type="hidden" name="merchant_id" value="119389"/>
											<input type="hidden" name="order_id" value="<?php echo(rand(10,10000));?>"/>
											<input type="hidden" name="amount" value="29500.00" class="amount"/> 
											...
											<input type="hidden" name="pagename" id="pagename" value="16th WILL Annual Women in Leadership Program" /> 
											<input type="hidden" name="sessionnamename" id="sessionnamename" class="sessionnamename" value="16th WILL Annual Women in Leadership Program" />
										...
										<p style="text-align:left; color:#fff;"><strong > Program Fee: </strong>
											<ul style="list-style-type: none;">
												<li style="color:#fff">
												<input type="radio" name="amntloc" id="amntloc" class="rad1" value="29500" checked="checked"/> <strong> In-Person Rs 25,000 plus GST </strong>
												</li>
												<li style="color:#fff">
												<input type="radio" name="amntloc" id="amntloc" class="rad1" value="23600"/> <strong> Online:   Rs. 20,000 plus GST </strong>
												</li>
											</ul>
										</p> 
											</div>
											...
											<button type="submit" class="btn btn-main-md" name="benchRegister" id="benchRegister1" disabled> Register</button>
											</div>
