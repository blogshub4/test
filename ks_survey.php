...
<h4>WILL Benchmarking: 2018<br /> "Best Employers for Women in Corporate India"</h4></p>

<p><h4 style="color:#000080;">Kronos Solutions India Pvt Ltd.</h4></p>
...
try {
    ...
    VALUES ('$empoyeename', '$Designation', '$Organization','$Gender','$mstatus','$experience','$location','$cdate','kronos')";
...
<script>window.location="ks_survey.php?s=y&id=<?php echo $last_id; ?>&p=1";</script>
...
<script>window.location="ks_survey.php?s=y&id=<?php echo $userID; ?>&p=2";</script>	
...
<script>window.location="ks_survey.php?s=y&id=<?php echo $userID; ?>&p=3";</script>		
...
<script>window.location="ks_survey.php?s=y&id=<?php echo $userID; ?>&p=4";</script>		
