...
<section class="page-title1 mentoring-bg-title1 overlay-dark1" >
	...
	<div class="container1" style=" width:100%; border-bottom:#FF0000">
		<div class="row">
			<div class="col-12 text-center1" ><br /><br><br><br><br><br><br>
       <!-- <img src="images/slider/nominee_slider.jpg" alt="4" style="width:100%;height: 100%;">-->
			</div>
		</div>
	</div>
</section>
			...
			<div class="description-one2">
					<div style="text-align:center;" >
						...
						<div style="margin-top:2%;float:left;" class='col-md-8'> 
							<div class="col-lg-12 col-md-12 align-self-center" style="background-color:#7608A9; padding: 30px;">	
										<p style="text-align:left; color:#fff;"><strong >Call Support Rs. 299 - for 30 minute</strong></p>
										<form action="ccavRequestHandler.php" class="row" method="post" enctype="multipart/form-data" id='form'>
											...
											<input type="hidden" name="amount" value="299.00" class="amount"/> 
											...
											<input type="hidden" name="pagename" id="pagename" value="Nominee" /> 
											<input type="hidden" name="sessionnamename" id="sessionnamename" class="sessionnamename" value="Call a Mentor" />
											...
											<button type="submit" class="btn btn-main-md" name="benchRegister" id="benchRegiste11r"> Register</button>
											</div>
