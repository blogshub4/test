	...
	<div class="container1" style=" width:100%; border-bottom:#FF0000">
		<div class="row">
			<div class="col-12 text-center1" ><br /><Br /><br /><br><br>
				<img src="images/2023/10/slider_popup.jpeg" alt="Boards Certification Program Mumbai" style="width:100%">
...
<h4>
WILL WOMEN ON BOARDS : PROGRAM & CERTIFICATION  <br><br>
<b style="color:#c00000;">MUMBAI SPECIAL SERIES : Discounted fees</b> <br><br>
	<strong>ONE DAY PROGRAM, DECEMBER 14, 2023 <!--DECEMBER 2023--> </strong> <br><br>
	<span style="font-size:22px;">Taj Lands End Mumbai<span><br>
</h4>
				...
				<div class="description-one">						
					...
					<div class="col-lg-8 col-sm-4 boxeffctcat1" style="background-color: white; text-align:left; float:left;" >
						<table border="1" cellpadding="8" width="100%">
							<tr>
								<td>
									<b style="color:#c00000;">Program Focus Area:</b><br />
									* How to prepare for Board Positions in career goals<br />
									* Understanding Board knowledge and Board Duties<br /> 
									* Skill required for Board Directors in Disruptive Times<br /> 
									* Competant Boards, and Board Effectiveness  <br />
									* ESG Mandate: New Board Requirements<br />
									* Getting Listed on the Directors Databank and Proficiency Test</a>
								</td>
							</tr>
						</table>
						<br>
						<table border="1" cellpadding="8" width="100%">
							<tr>
								<td>
									<b style="color:#c00000;">Delegate Fee: Rs. 15,000 :</b><br />
									* Includes Full day Conference Board Training Sessions, with Stellar Speakers<br />
									* Guidance Sessions on IICA Board Directors Listing and Directors Databank<br /> 
									* All Participants will be listed on the landmark  "WILL Board Directors Roster,"" available for all &nbsp;&nbsp;&nbsp;Board search and Board appointments<br /> 
									* Resource Materials:  Background Powerpoints, Research Reports on Board Presence,
Reference &nbsp;&nbsp;&nbsp;Books <br />
									* Full One-year membership of the WILL Forum, including #WILLMeetUP! #WILLWebMentoring  &nbsp;&nbsp;&nbsp;#WILLWhatsappChat<br />
									* Networking Lunch!<br>
								* WILL Board Certification Ceremony</a>
								</td>
							</tr>
						</table>
						<div style="text-align:center;"><br>
						<a href="pdf/WILL_Mumbai_Series.pdf" target="_blank" style="color:#c00000;"><strong>
						<img src="images/2023/9/board_download_icon.jpeg" height="auto" width="80">	
						Click here to download brochure.</strong></a>
</div>
					</div>
				</div>
			</div>
					...
					<div style="text-align:center;" >
						...
						<div style="margin-top:2%;float:left;" class='col-md-8'> 
							<div class="col-lg-12 col-md-12 align-self-center" style="background-color:#008000; padding: 30px;">	
										...
										Program Fee: Rs. 15,000 per participant + GST
										</strong></p> 
										<form id='form' name='form' onsubmit="return validate();" action="ccavRequestHandler.php" class="row" method="post" enctype="multipart/form-data"  >
											...
											<input type="hidden" name="pagename" id="pagename" value="Boards Certification Program Mumbai Discounted  fees" /> 
											<input type="hidden" name="sessionnamename" id="sessionnamename" class="sessionnamename" value="Boards Certification Program Mumbai Discounted  fees" />
											...
											<input type="hidden" name="billing_sem_date" id="billing_sem_date" value="DECEMBER 14">
...
function RestrictSpaceSpecial(event) {  alert("TEST")
