...
<p>
<h4>WILL Benchmarking: 2021<br /> "Best Employers for Women in Corporate India"</h4></p>
<p><h4 style="color:#000080;">Go Avega</h4></p>
...
try {
    ...
    VALUES ('$empoyeename', '$Designation', '$Organization','$Gender','$mstatus','$experience','$location','$cdate','GoAvega')";
...
<script>window.location="govega_survey.php?s=y&id=<?php echo $last_id; ?>&p=1";</script>
...
<script>window.location="govega_survey.php?s=y&id=<?php echo $userID; ?>&p=2";</script>	
...
<script>window.location="govega_survey.php?s=y&id=<?php echo $userID; ?>&p=3";</script>		
...
<script>window.location="govega_survey.php?s=y&id=<?php echo $userID; ?>&p=4";</script>		
