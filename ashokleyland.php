...
<p>
<h4>WILL Benchmarking: 2019<br /> "Best Employers for Women in Corporate India"</h4></p>
<p><h4 style="color:#000080;">Ashok Leyland</h4></p>
<h6>Phase 1- WILL Benchmarking Questionnaire</h6>
</div>	

<h5><u>Mission and Mandate:</u></h5>

<p>Given the rising talent and increasing role of women in business success, it is the appropriate

time to put into place an institutional set of criteria that will become an authentic reference

point for benchmarking the "Best Employer Companies for Women in Corporate India."</p>



<p><br />The "WILL Benchmarking Questionnaire" will help to understand how key executive men and

women view the entire issues of best practices for women in the workplace, corporate

disclosures on women in leadership positions, the value of gender leadership assessment tool-

kits, and the critical importance for mentoring women for advanced management positions and

boardrooms - in your organization</p>



<p><br />

The WILL Questionnaire will require responses from at least 40 women and men executives in

your company and responses can be to sent via email directly to willforum@pamasiaglobal.com



<p>All responses to the questionnaire will remain confidential, and we are committed to the privacy

of all our stakeholders.</p>



<p>Thank you for your time and inspiration on building women in leadership.</p>
...
try {
    ...
    VALUES ('$empoyeename', '$Designation', '$Organization','$Gender','$mstatus','$experience','$location','$cdate','ashokleyland')";
...
<script>window.location="ashokleyland.php?s=y&id=<?php echo $last_id; ?>&p=1";</script>
...
<script>window.location="ashokleyland.php?s=y&id=<?php echo $userID; ?>&p=2";</script>	
...
<script>window.location="ashokleyland.php?s=y&id=<?php echo $userID; ?>&p=3";</script>		
...
<script>window.location="ashokleyland.php?s=y&id=<?php echo $userID; ?>&p=4";</script>		
...
--> 
    ...
    <tr>
        ...
        <td> Question :8 In your view, do you feel that your Company has a "Supportive Culture" within the organization?</td>
...
<tr><td colspan="2"><h5>B. Career Advancement Policies:     </h5></td></tr>
    ...
    <tr>
        ...
        <td> Question :16 Does your Company provide opportunities for cross-industry Mentoring and Executive Coaching Programs for Women - from external benchmarking organizations like the WILL Forum? </td>
